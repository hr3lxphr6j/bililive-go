...
func (m *MockManager) GetListener(arg0 context.Context, arg1 types.LiveID) (Listener, error) {
	m.ctrl.T.Helper()
...
func (m *MockManager) HasListener(arg0 context.Context, arg1 types.LiveID) bool {
	m.ctrl.T.Helper()
...
func (m *MockManager) RemoveListener(arg0 context.Context, arg1 types.LiveID) error {
	m.ctrl.T.Helper()
